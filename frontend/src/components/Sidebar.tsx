    ...
    <nav className="sidebar" role="navigation" aria-label="Main navigation">
      <div className="sidebar-items">
        ...
        <button
          ...
          onKeyPress={(e) => handleKeyPress(e, () => handleMenuItemClick('transactions'))}
          title="Transactions"
        ...
        <button
          ...
          onKeyPress={(e) => handleKeyPress(e, () => handleMenuItemClick('analysis'))}
          title="AI Analysis"
        ...
        {/* Rebalancing */}
        <button
          className={`sidebar-item ${activeTab === 'rebalancing' ? 'active' : ''}`}
          onClick={() => handleMenuItemClick('rebalancing')}
          onKeyPress={(e) => handleKeyPress(e, () => handleMenuItemClick('rebalancing'))}
          title="Rebalancing"
        ...
        {/* Strategy */}
        <button
          className={`sidebar-item ${activeTab === 'strategy' ? 'active' : ''}`}
          onClick={() => handleMenuItemClick('strategy')}
          onKeyPress={(e) => handleKeyPress(e, () => handleMenuItemClick('strategy'))}
          title="Strategy"
